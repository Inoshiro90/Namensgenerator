function generateRandomFirstNameOrcMale() {
	let firstName;
	let previousVowel = '';
	...
	do {
		const syllable1 =
			orcFirstNameMaleSyllable1[Math.floor(Math.random() * orcFirstNameMaleSyllable1.length)];
		const syllable2 =
			orcFirstNameMaleSyllable2[Math.floor(Math.random() * orcFirstNameMaleSyllable2.length)];
		const syllable3 =
			orcFirstNameMaleSyllable3[Math.floor(Math.random() * orcFirstNameMaleSyllable3.length)];
		const syllable4 =
			orcFirstNameMaleSyllable4[Math.floor(Math.random() * orcFirstNameMaleSyllable4.length)];
		const syllable5 =
			orcFirstNameMaleSyllable5[Math.floor(Math.random() * orcFirstNameMaleSyllable5.length)];
