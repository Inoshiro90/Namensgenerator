function generateRandomFirstNameGnomeNonBinary() {
	let firstName;
	let previousVowel = '';
	...
	do {
		...
		Math.floor(
			Math.random() *
				(gnomeFirstNameMaleSyllable1.length +
					gnomeFirstNameFemaleSyllable1.length)
		)
	];
	const syllable2 = gnomeFirstNameMaleSyllable2.concat(gnomeFirstNameFemaleSyllable2)[
		Math.floor(
			Math.random() *
				(gnomeFirstNameMaleSyllable2.length +
					gnomeFirstNameFemaleSyllable2.length)
		)
	];
	const syllable3 = gnomeFirstNameMaleSyllable3.concat(gnomeFirstNameFemaleSyllable3)[
		Math.floor(
			Math.random() *
				(gnomeFirstNameMaleSyllable3.length +
					gnomeFirstNameFemaleSyllable3.length)
		)
	];
	const syllable4 = gnomeFirstNameMaleSyllable4.concat(gnomeFirstNameFemaleSyllable4)[
		Math.floor(
			Math.random() *
				(gnomeFirstNameMaleSyllable4.length +
					gnomeFirstNameFemaleSyllable4.length)
		)
	];
	const syllable5 = gnomeFirstNameMaleSyllable5.concat(gnomeFirstNameFemaleSyllable5)[
		Math.floor(
			Math.random() *
				(gnomeFirstNameMaleSyllable5.length +
					gnomeFirstNameFemaleSyllable5.length)
		)
	];
