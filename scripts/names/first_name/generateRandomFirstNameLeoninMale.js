function generateRandomFirstNameLeoninMale() {
	let firstName;
	let previousVowel = '';
	...
	do {
		const syllable1 =
			leoninFirstNameMaleSyllable1[
				Math.floor(Math.random() * leoninFirstNameMaleSyllable1.length)
			];
		const syllable2 =
			leoninFirstNameMaleSyllable2[
				Math.floor(Math.random() * leoninFirstNameMaleSyllable2.length)
			];
		const syllable3 =
			leoninFirstNameMaleSyllable3[
				Math.floor(Math.random() * leoninFirstNameMaleSyllable3.length)
			];
		const syllable4 =
			leoninFirstNameMaleSyllable4[
				Math.floor(Math.random() * leoninFirstNameMaleSyllable4.length)
			];
		const syllable5 =
			leoninFirstNameMaleSyllable5[
				Math.floor(Math.random() * leoninFirstNameMaleSyllable5.length)
			];
