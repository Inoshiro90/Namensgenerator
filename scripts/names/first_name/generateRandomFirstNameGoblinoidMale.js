function generateRandomFirstNameGoblinoidMale() {
	let firstName;
	let previousVowel = '';
	...
	do {
		const syllable1 =
			goblinoidFirstNameMaleSyllable1[
				Math.floor(Math.random() * goblinoidFirstNameMaleSyllable1.length)
			];
		const syllable2 =
			goblinoidFirstNameMaleSyllable2[
				Math.floor(Math.random() * goblinoidFirstNameMaleSyllable2.length)
			];
		const syllable3 =
			goblinoidFirstNameMaleSyllable3[
				Math.floor(Math.random() * goblinoidFirstNameMaleSyllable3.length)
			];
		const syllable4 =
			goblinoidFirstNameMaleSyllable4[
				Math.floor(Math.random() * goblinoidFirstNameMaleSyllable4.length)
			];
		const syllable5 =
			goblinoidFirstNameMaleSyllable5[
				Math.floor(Math.random() * goblinoidFirstNameMaleSyllable5.length)
			];
