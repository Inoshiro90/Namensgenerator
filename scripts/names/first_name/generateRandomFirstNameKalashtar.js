function generateRandomFirstNameKalashtar() {
	let firstName;
	let previousVowel = '';
	...
	do {
		...
		const syllable3 =
			kalashtarFirstNameSyllable3[
				Math.floor(Math.random() * kalashtarFirstNameSyllable3.length)
			];
		const syllable4 =
			kalashtarFirstNameSyllable4[
				Math.floor(Math.random() * kalashtarFirstNameSyllable4.length)
			];
		const syllable5 =
			kalashtarFirstNameSyllable5[
				Math.floor(Math.random() * kalashtarFirstNameSyllable5.length)
			];
