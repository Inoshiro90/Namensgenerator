function generateRandomLastNameGenasiAir() {
	let lastName;

	const syllable1 =
		genasiLastNameAirSyllable1[Math.floor(Math.random() * genasiLastNameAirSyllable1.length)];
	let syllable2;

	do {
		syllable2 =
			genasiLastNameAirSyllable2[
				Math.floor(Math.random() * genasiLastNameAirSyllable2.length)
			];
	} while (
