function generateRandomLastNameGenasiWater() {
	let lastName;

	const syllable1 =
		genasiLastNameWaterSyllable1[Math.floor(Math.random() * genasiLastNameWaterSyllable1.length)];
	let syllable2;

	do {
		syllable2 =
			genasiLastNameWaterSyllable2[
				Math.floor(Math.random() * genasiLastNameWaterSyllable2.length)
			];
	} while (
